...
const faqs = [
  [
    'Für welche Creator ist Klyger geeignet?',
    'Klyger arbeitet mit Creatorn, die eine aktive Community haben und daraus eine eigene Marke aufbauen möchten. Keine Mindest-Followerzahl - wichtig sind Expertise und Ambition.',
  ],
  [
