...
const packages = [
  {
    ...
    description:
      "Nutze das Framework, um sofort mit dem Aufbau deiner Marke zu beginnen. KI-gestützt, strukturiert, in deinem Tempo.",
  ...
  },
  {
    ...
    description:
      "Buche genau die Leistung, die du aktuell brauchst - modular aus unserem Markenprozess.",
  ...
  },
  {
    ...
    description:
      "Wir bauen gemeinsam deine Marke, dein Unternehmen und die Vermarktung deiner Produkte.",
